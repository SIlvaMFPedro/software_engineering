...
public class chessInfoConsumer {
    private static final String PERSISTENCE_UNIT_NAME = "moves";
    ...
    private static void saveInDatabase (String s){
        // create new move and write on database
        //persistency instanciation
        factory = Persistence.createEntityManagerFactory(PERSISTENCE_UNIT_NAME);
        EntityManager em = factory.createEntityManager();
        // read the existing entries and write to console
        Query q = em.createQuery("select t from Move t");
        List<Move> moveList = q.getResultList();
...
//        }
    ...
    private static void writeToFile(String s){
        ...
        // proceed to writeng on the file
