...
public class Queen extends Piece
{
  ...
  {
    return arrayToSet(new PiecePositionGenerator[] { new RowPositionGenerator(this.player, gameState), new ColumnPositionGenerator(this.player, gameState), new DiagonalPositionGenerator(this.player, gameState) });
  }
