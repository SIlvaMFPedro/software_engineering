...
public class ChessResourceTest {
    ...
    @Test
    public void testInitialGetCreatesNewGame() throws IOException {
        ...
        String game = chess.getGame(request, response);
    ...
    public void testGetFetchesFromSession() {
        ...
        GameStateBean returnedGame = chess.getGameState(request, response);
        //String returnedGame = chess.getGame(request, response);
    ...
    public void testPutMakesTransition() {
        ...
        //GameState blackFirstMove = makeStateWithMoves("d2 d4", "f2 f4");
    ...
    @Test
    public void testPostGame() throws IOException {
        GameState storedGame = mockWhiteFirstMove();
